...
export class UserService {
  ...
  crediterUtilisateur(user: User, amount: number): Observable<User> {
    return this.httpClient.post<User>(this.urlServeur + 'user/credit/' + user.id, amount);
  }
  ...
  getUtilisateur(user: User): Observable<User> {
    return this.httpClient.get<User>(this.urlServeur + 'user/find/' + user.id);
  }
